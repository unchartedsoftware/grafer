...
export async function quickstart4(container: HTMLElement): Promise<void> {
    ...
    controller.on(UX.picking.PickingManager.events.hoverOn, () => {
    ...
    controller.on(UX.picking.PickingManager.events.hoverOff, () => {
